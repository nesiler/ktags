...
func TestMaskReplacesEachPattern(t *testing.T) {
	tests := []struct {
		...
		{"password yaml anchor", "password: &anchor anchoredsecret", "password: [masked] [masked]"},
		{"password yaml anchor then tag", "password: &a !!str anchtagsecret", "password: [masked] !!str [masked]"},
		{"password yaml tag then anchor", "password: !!str &a tagsecret", "password: !!str [masked] [masked]"},
		{"token yaml anchor quoted", `token: &t "a b"`, `token: [masked] "[masked]"`},
		{"password ini ampersand value", "password=&secret user=bob", "password=[masked] [masked]"},
		{"password double colon", "password:: doublecolon", "password:: [masked]"},
